...
p4 = ggplot() + 
  geom_line(data = summary_data, aes(x = Species, y = mean_slength), group = 1, color = "black", size = 1, linetype = "solid") + 
  ...
  geom_line(data = summary_data, aes(x = Species, y = mean_swidth), group = 1, color = "grey", size = 0.5, linetype = "dashed") + 
